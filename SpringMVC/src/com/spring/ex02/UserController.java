	...
	*/
	...
	public ModelAndView login(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(request.getParameter("userID")!=null) {
			...
			mav.addObject("passwd", passwd);
			//mav.setViewName("result");
			mav.setViewName(viewName);//뷰 이름을 지정
...
*/
	public ModelAndView memberInfo(HttpServletRequest request, HttpServletResponse response) throws Exception {
	    ...
	    if(request.getParameter("id")!=null) {
		    ...
		    memberDao.insert(new Member_ex().setName(name).setEmail(email).setPassword(pwd));
...
//		Member_ex member = new Member_ex();
	    if(request.getParameter("id")!=null) {
		    ...
		    ;
		    memberDao.update(new Member_ex().setName(name).setEmail(email).setPassword(pwd));
